...
import { LayoutDashboard, Calendar, LogOut, Menu, X, User, Star, Bell, Clock } from 'lucide-react'
import { useState } from 'react'
import { cn } from '@/lib/utils'

const navItems = [
  { href: '/therapist', icon: LayoutDashboard, label: 'Dashboard & Appointments' },
  { href: '/therapist/schedule', icon: Clock, label: 'My Schedule' },
  { href: '/therapist/history', icon: Calendar, label: 'Work History' },
  { href: '/therapist/reviews', icon: Star, label: 'My Reviews' },
  { href: '/therapist/notifications', icon: Bell, label: 'Notifications' },
  { href: '/therapist/profile', icon: User, label: 'Profile Settings' },
]
        ...
        <div className="p-6 border-b border-gold-400/10">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-gold-400 text-xs tracking-wider uppercase">Therapist Portal</span>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-b border-gold-400/10">
          <div className="flex items-center gap-3 p-3 glass-card">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-cream/50 truncate uppercase tracking-widest">Expert</p>
            </div>
          </div>
        </div>
